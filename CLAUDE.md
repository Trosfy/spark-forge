...
- Model registry (`plugins/forge/models/*.json`): **family = graph (code), version = profile (data)**.
  New version → add a profile JSON; new architecture → add a family in `scripts/model_registry.py`.
